...
from .views import (VistaListaLicores, VistaDetalleLicor, VistaResultadosBusqueda, VistaLicoresFiltrados, 
                    delete_resenha, profile_view, update_resenha, VistaCarrito, VistaAgregarAlCarrito, 
                    VistaVerWishlist, VistaAgregarAWishlist, VistaAgregarLicor, VistaEditarLicor, 
                    AgregarLicorView)

urlpatterns = [
    path('profile/', profile_view, name='profile'),
    path('licores/', VistaListaLicores.as_view(), name='lista_licores'),
    path('licores/<uuid:pk>/', VistaDetalleLicor.as_view(), name='detalle_licor'),
    ...
    path('editar_licor/<uuid:pk>/', VistaEditarLicor.as_view(), name='editar_licor'),
    path('agregar/', AgregarLicorView.as_view(), name='agregar_licor'),
]
